...
ok(       Authorization::AccessControl::Grant->new(resource => 'User', action => 'read', restrictions => {owned => 1}), 'required params + restrictions');
...
my $pc = Authorization::AccessControl::Grant->new(resource => 'Image', action => 'view', restrictions => {image_id => 9, rep => 'small'});
...
$pc = Authorization::AccessControl::Grant->new(role => 'admin', resource => 'Image', action => 'view', restrictions => {image_id => 9, rep => 'small'});
