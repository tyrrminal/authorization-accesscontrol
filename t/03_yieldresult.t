...
ok(Authorization::AccessControl::Dispatch->new(granted => true, entity => "v")
  ->granted(sub($entity) {  }), 'granted one arg' );
ok( dies { Authorization::AccessControl::Dispatch->new(granted => true, entity => "v")
  ->granted(sub() {  }) }, 'granted no args' );

ok(Authorization::AccessControl::Dispatch->new(granted => false, entity => "v")
  ->denied(sub() {  }), 'denied no args' );
ok( dies { Authorization::AccessControl::Dispatch->new(granted => false, entity => "v")
  ->denied(sub($entity) {  }) }, 'denied one arg' );

ok(Authorization::AccessControl::Dispatch->new(granted => undef, entity => "v")
  ->null(sub() {  }), 'null no args' );
ok( dies { Authorization::AccessControl::Dispatch->new(granted => undef, entity => "v")
...
$r = [];
Authorization::AccessControl::Dispatch->new(granted => true, entity => "v")
  ->granted(sub($entity) { push($r->@*, $entity) });
is($r, ["v"], 'check granted called with data value');

$r = [];
Authorization::AccessControl::Dispatch->new(granted => true, entity => undef)
  ->granted(sub($entity) { push($r->@*, $entity) });
...
$r = [];
Authorization::AccessControl::Dispatch->new(granted => false, entity => "v")
  ->denied(sub() { push($r->@*, "d") });
is($r, ["d"], 'check denied called with data value');

$r = [];
Authorization::AccessControl::Dispatch->new(granted => false, entity => undef)
  ->denied(sub() { push($r->@*, "d") });
...
$r = [];
Authorization::AccessControl::Dispatch->new(granted => undef, entity => "v")
  ->null(sub() { push($r->@*, "n") });
is($r, ["n"], 'check null called with data value');

$r = [];
Authorization::AccessControl::Dispatch->new(granted => undef, entity => undef)
  ->null(sub() { push($r->@*, "n") });
